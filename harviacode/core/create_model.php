...
$string .="\n\n    // datatables
    function json() {
        ...
        \$this->datatables->unset_column('$pk');
        \$this->datatables->add_column('nomor','1');
        \$this->datatables->add_column('actions', '<a href=\"javascript:void(0);\" class=\"hapus_record btn btn-danger btn-sm\" data-id=\"$1\"><i class=\"fa fa-trash\"></i> Delete</a> <a href=\"'.site_url('users/update/$1').'\" class=\"update_record btn btn-success btn-sm\" data-id=\"$1\"><i class=\"fa fa-edit\"></i> Update</a>', '".$columnall.",nomor,actions');
